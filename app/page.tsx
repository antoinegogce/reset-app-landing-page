    ...
    <form onSubmit={onSubmit} className="rounded-[var(--reset-radius-lg)] border border-[var(--reset-gray-100)] bg-[var(--reset-white)] p-6">
      ...
      <label className="mt-5 block">
        ...
        <input
          ...
          className={`h-11 w-full rounded-[var(--reset-radius-md)] border bg-white px-4 text-[14px] text-[var(--reset-encre)] placeholder:text-[var(--reset-gray-accent)] shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-[var(--reset-black)] focus:ring-offset-1 ${getEmailBorderClass()}`}
        />
      </label>
